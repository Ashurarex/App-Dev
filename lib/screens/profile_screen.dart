                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          '9 beautiful themes including AMOLED',
                          style: TextStyle(
                            fontSize: 12,
                            color: isDark ? Colors.grey[400] : Colors.grey[600],
                          ),
                    ...
                    // Custom Icons Card (Premium - Coming Soon)
                    Card(
                      color: isDark ? Colors.grey[850] : Colors.white,
                      elevation: 4,
                      child: ListTile(
                        ...
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Custom icons coming soon! Edit habits to customize.'),
